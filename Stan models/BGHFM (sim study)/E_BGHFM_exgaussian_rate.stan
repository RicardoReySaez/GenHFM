...
generated quantities {
    ...
    vector[J] mu_tau2; for(j in 1:J) { mu_tau2[j] = mean(inv_square(rate[,j])); }
    // Signal-to-noise ratios
    vector[J] gamma2 = square(sd_theta)./(square(mu_sigma) + square(sd_sigma) + mu_tau2);
